package com.gre.web.controller;
...
import com.gre.maker.meta.MetaValidator;
import com.gre.web.annotation.AuthCheck;
import com.gre.web.common.BaseResponse;
import com.gre.web.common.DeleteRequest;
import com.gre.web.common.ErrorCode;
import com.gre.web.common.ResultUtils;
import com.gre.web.constant.UserConstant;
import com.gre.web.exception.BusinessException;
import com.gre.web.exception.ThrowUtils;
import com.gre.web.manager.CacheManager;
import com.gre.web.manager.CosManager;
import com.gre.maker.meta.Meta;
import com.gre.web.model.dto.generator.*;
import com.gre.web.model.entity.Generator;
import com.gre.web.model.entity.User;
import com.gre.web.model.vo.GeneratorVO;
import com.gre.web.service.GeneratorService;
import com.gre.web.service.UserService;
...
public class GeneratorController {
    ...
    public void downloadGeneratorById(long id, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String zipFilePath = getCacheFile(id, filepath);
    ...
    public void useGenerator(@RequestBody GeneratorUseRequest generatorUseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        // 执行脚本
        // 找到脚本文件所在路径
        // 如果不是windows系统，找generator文件而不是bat
    ...
    public void cacheGeneratorById(@RequestBody GeneratorCacheRequest generatorCacheRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String zipFilePath = getCacheFile(id, distPath);
        try {
            cosManager.download(distPath, zipFilePath);
        } catch (Exception e) {
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "生成器下载失败");
     ...
     * @return
     */
    public String getCacheFile(long id, String distPath) {
        String projectPath = System.getProperty("user.dir");
