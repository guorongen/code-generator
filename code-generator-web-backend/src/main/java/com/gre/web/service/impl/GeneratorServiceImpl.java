package com.gre.web.service.impl;
...
import com.gre.web.constant.CommonConstant;
...
public class GeneratorServiceImpl extends ServiceImpl<GeneratorMapper, Generator> implements GeneratorService {
    ...
    public QueryWrapper<Generator> getQueryWrapper(GeneratorQueryRequest generatorQueryRequest) {
        ...
        queryWrapper.eq(StringUtils.isNoneBlank(version), "version", version);
        queryWrapper.eq(StringUtils.isNoneBlank(author), "author", author);
        queryWrapper.eq(StringUtils.isNoneBlank(distPath), "distPath", distPath);
